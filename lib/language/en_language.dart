class EnLanguage {
  Map<String, String> enLanguage = {
    ...
    'notice': 'Notice',
    'add_success':
        'This channel has been successfully added to favorites lists',
    'remove_success':
        'This channel has been successfully removed from favorites lists',
    'sorry': 'Sorry',
    'no_previous': 'No more previous channel',
    'no_more_list': 'This is the last channel',
    'please_enter_text': 'Please enter text to search !',
    'cant_use':
        'Sorry, please use the software back button that located on the left corner of screen',
    'exit': 'Exit',
